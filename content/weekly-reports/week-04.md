...
<div class="gallery">
  ...
  <figure>
    <img src="../../images/dev/tiny-player.png" alt="A tiny cylinder next to a box">
    <figcaption>
  ...
  <figure>
    <img src="../../images/dev/net-bug.png" alt="A block of code with a single line circled in red">
    <figcaption>
      learn how he fixed player movement with just this one line 🤯
    </figcaption>
  </figure>
  <figure>
    <img src="../../images/dev/particles.png" alt="Little red squares flying upwards">
    <figcaption>
      kenzo's particles !!
    </figcaption>
  </figure>
  <figure>
    <img src="../../images/concept/cave-napkin.png" alt="Napkin drawing describing a map idea, with the boss trapped inside a time bubble next to a relatively tiny player">
    <figcaption>
      idea-ing
    </figcaption>
  </figure>
  <figure>
    <img src="../../images/dev/dark-cave.png" alt="Grey stone walls and a green floor barely visible in darkness">
    <figcaption>
      adding another model and for some reason it only renders when the other models aren't loaded
    </figcaption>
  </figure>
  <figure>
    <img src="../../images/dev/shadow.png" alt="A square shadow from the cube being cast on the green floor">
    <figcaption>
  ...
  <figure>
    <img src="../../images/dev/donut.png" alt="A pink frosted donut">
    <figcaption>
      ill try it now w the donut
    </figcaption>
  </figure>
  <figure>
    <img src="../../images/dev/wall-shadow.png" alt="Black lines on the green floor">
    <figcaption>
  ...
  <figure>
    <img src="../../images/dev/concept-map.png" alt="A white room layout">
    <figcaption>
      yay sample map! it doesnt have color or anything
    </figcaption>
  </figure>
  <figure>
    <img src="../../images/dev/shadows.png" alt="Midst the pitch black darkness, there are two shadows being cast from the two light sources by the concept map">
    <figcaption>
...
We adjusted movement, created preliminary Blender models, made the game first-person, added a freecam mode for debugging purposes, and added a particle system, in addition to better structuring our code to prepare for future features.

Our goals for next week, by team:

- Networking and game logic

  - Continue to refine player movement
  - Create a system for interacting with and physically combining objects
  - Add multiplayer support

- Graphics and art

  - Begin work on entity models
  - Add more map details
  - Better integrate the toon shader into our render pipeline
  - Extend the particle system

At this point, we might begin redistributing team members from graphics to game logic.

We're still excited to continue working on our game, but we're starting to feel a bit behind. Nonetheless, our [post-meeting social on Sunday](#utc-social) greatly helped our morale.
...
1. what were your concrete goals for the week?
   ...
   Geting a player object working, setting up a demo world with objects for the player to run around and jump on top of. Basically, get movement in a 3d space working and tune it (to a reasonable extent) so that it feels right. Start making game object collisions affect the Game state for certain interactions (like 2 objects colliding to make a larger or crafted object).

2. what goals were you able to accomplish?

   I got the movement partially working with Tyler and he finished it later. I fixed the player input so that it actually continually moves the player when you press the button. Running around and pushing objects was working.

3. if the week went differently than you had planned, what were the reasons? note that this happens regularly…I would prefer you to be aggressive in what you want to try accomplish rather than limit yourself to goals you know you’ll easily achieve. so answering this question is more of a reflection on the development process and the surprises you encounter, it’s not at all an evaluation.

   I wasn't able to tune player movement, and I wasn't able to get collision events started this week. This is just because I had a lot less time to work on things this week which is unfortunate :(. I am in Hawai'i though which is pretty fortunate!

4. what are your specific goals for the next week?

   Get re-acclimated with the group and figure out what everyone is doing. Help Tyler create an interactable entity class, get a prototype where players can pick up and throw around objects. Make objects that delete themselves and turn into new game objects when they collide!
...
6. what is your individual morale (which might be different from the overall group morale)?
   ...
   It's pretty good overall. I feel well-rested and excited to continue work on the game when I return from my trip!

<div class="gallery">
  <figure>
    <img src="../../images/hi/hawaii1.jpg" alt="Sheep on a grassy field">
  </figure>
  <figure>
    <img src="../../images/hi/hawaii2.jpg" alt="A steel rail bridge">
  </figure>
  <figure>
    <img src="../../images/hi/hawaii3.jpg" alt="Lush overgrown cave">
  </figure>
  <figure>
    <img src="../../images/hi/hawaii4.jpg" alt="Observatories on a rocky plain">
  </figure>
  <figure>
    <img src="../../images/hi/hawaii5.jpg" alt="Lush greenery by a stream">
  </figure>
  <figure>
    <img src="../../images/hi/hawaii6.jpg" alt="A waterfall forming a rainbow from its mist on a green, overgrown cliffside">
  </figure>
</div>
...
1. what were your concrete goals for the week?
   ...
   Build a basic player input system to allow players to progress through the game

1. what goals were you able to accomplish?

   Designed the material system to apply frictions on the ground. Constructed a basic movement script that just apply physical force to players to move them.

1. if the week went differently than you had planned, what were the reasons? note that this happens regularly…I would prefer you to be aggressive in what you want to try accomplish rather than limit yourself to goals you know you’ll easily achieve. so answering this question is more of a reflection on the development process and the surprises you encounter, it’s not at all an evaluation.

   This week went pretty much the same way as I planned 😄
...
1. what did you learn this week, if anything (and did you expect to learn it?)
   ...
   I learned how cannon-es handles friction using contactmaterial system, which is a fascinating idea that enable atransitive friction properties

1. what is your individual morale (which might be different from the overall group morale)?

   Pretty normal. Although I do want to spend more time on this moving forward as I feel like we are a little bit behind.
...
My current morale is still pretty motivated. However, I'm a bit annoyed that the player can't move anymore once it lands, so the game is currently less playable than it was before.
...
Present: Kenzo, Sean, Will, Killian, Marcelo, Tyler
...
<div class="gallery" id="utc-social">
  <figure>
    <img src="../../images/social/utc.jpg" alt="Sheep on a grassy field">
  </figure>
  <figure>
    <img src="../../images/social/utc-bereal.jpg" alt="Sheep on a grassy field">
  </figure>
</div>
